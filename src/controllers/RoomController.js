...
module.exports = {
    // ?-- 'async' é o parâmetro necessário para tornar a função 'paciente'. Ele funciona em conjunto com o parâmetro 'await' dentro do código, que tem a função de ordenar a execução do código. Ou seja, quando tiver o 'await' antes do parâmetro, o Javascript irá executar completamente aquele trecho antes de passar para a próxima linha, evitando erros de inicialização já que estamos utilizando funções para enviar informações para o BD --? //
